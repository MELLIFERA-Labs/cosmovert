...
bot.on('message', async ctx => {
	...
	if(part1 && part2) {
		...
		await ctx.reply('❗️❗️❗️❗️❗️ Make sure that prefix is correct, if you make mistake in prefix address will convert wrong ❗❗️❗️❗️')
	}
